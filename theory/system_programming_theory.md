...
- ``int sem_post(sem_t *sem)``
	...
	- ако броячът стане повече от 0, се събужда друг процес, който заключва семафора
...
- ``int sem_trywait(sem_t *sem)``
	...
	- връща **EAGAIN** ако семафорyt не може да се заключи веднага (т.е. вече е бил заключен)
